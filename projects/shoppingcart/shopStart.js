...
function sub_selection(x) {
 ...
 if(quantities[x]> 0){
    ...
    window.alert("Add Items To Your Cart");
}
...
function display_all() {
    ...
    for (i = 0; i < items.length; i++) {
        ...
        myTable += "<td><button onclick='sub_selection(" + i + ")'>Remove</button></td>";
    ...
    myTable += "<td><button onclick='displayTotal()'>Check Out</button></td>";
